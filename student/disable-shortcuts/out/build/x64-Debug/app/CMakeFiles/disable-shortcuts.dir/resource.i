...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(
    wchar_t*, __RETURN_POLICY_DST, , wcsncat, wcsncat_s,
        wchar_t,
     , wchar_t,        _Destination,
         wchar_t const*, _Source,
                            size_t,         _Count
...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(
    wchar_t*, __RETURN_POLICY_DST, , wcsncpy, wcsncpy_s,
                wchar_t,
       , wchar_t,        _Destination,
                  wchar_t const*, _Source,
                                     size_t,         _Count
...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(
    wchar_t*, __RETURN_POLICY_DST, , _wcsnset, _wcsnset_s,
           wchar_t,
     , wchar_t, _String,
                               wchar_t, _Value,
                               size_t,  _MaxCount
...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(
    wchar_t*, __RETURN_POLICY_DST, , _wcsset, _wcsset_s,
      wchar_t,
     ,               wchar_t, _String,
                          wchar_t, _Value
    )
...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(
    wchar_t*, __RETURN_POLICY_DST, , _wcslwr_l, _wcslwr_s_l,
      wchar_t,
     ,               wchar_t,   _String,
                      _locale_t, _Locale
    )
...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(
    wchar_t*, __RETURN_POLICY_DST, , _wcsupr_l, _wcsupr_s_l,
      wchar_t,
     ,               wchar_t,   _String,
                      _locale_t, _Locale
    )
...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(
    char*, __RETURN_POLICY_DST, , _strlwr_l, _strlwr_s_l,
      char,
     ,               char,      _String,
                      _locale_t, _Locale
    )
...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(
    char*, __RETURN_POLICY_DST, , strncat, strncat_s,
        char,
     , char,        _Destination,
         char const*, _Source,
                            size_t,      _Count
...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(
    char*, __RETURN_POLICY_DST, , strncpy, strncpy_s,
                    char,
       , char,        _Destination,
                  char const*, _Source,
                                     size_t,      _Count
...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(
    char*, __RETURN_POLICY_DST, , _strnset, _strnset_s,
        char,
     , char,   _Destination,
                            int,    _Value,
                            size_t, _Count
...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(
    char*, __RETURN_POLICY_DST, , _strupr_l, _strupr_s_l,
      char,
     ,               char,      _String,
                      _locale_t, _Locale
    )
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "FileDescription",  "A simple app to disable keyboardshortcuts"
            VALUE "FileVersion",      "1.0.1"
            VALUE "InternalName",     "disable-shortcuts"
            VALUE "LegalCopyright",   "Copyright (C) 2020  Benoit Blanchon"
            VALUE "OriginalFilename", "disable-shortcuts.exe"
            VALUE "ProductName",      "Disable Shortcuts"
...
BEGIN
  1, "Next-Exam"
  2, "Les touches Windows sont désactivées"
END
...
BEGIN
  1, "Next-Exam"
  2, "Las teclas Windows están desactivadas"
END
