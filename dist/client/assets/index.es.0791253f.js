import { a4 as commonjsGlobal } from "./vendor.271cff46.js";
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$7 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O2, P) {
  ...
  if (hasOwn$8(O2, P))
    return createPropertyDescriptor$3(!call$b(propertyIsEnumerableModule.f, O2, P), O2[P]);
};
...
objectDefineProperty.f = DESCRIPTORS$5 ? V8_PROTOTYPE_DEFINE_BUG$1 ? function defineProperty(O2, P, Attributes) {
  anObject$f(O2);
  P = toPropertyKey$1(P);
...
var classof$7 = TO_STRING_TAG_SUPPORT ? classofRaw : function(it) {
  var O2, tag, result;
  return it === void 0 ? "Undefined" : it === null ? "Null" : typeof (tag = tryGet(O2 = Object$2(it), TO_STRING_TAG$1)) == "string" ? tag : CORRECT_ARGUMENTS ? classofRaw(O2) : (result = classofRaw(O2)) == "Object" && isCallable$8(O2.callee) ? "Arguments" : result;
};
...
var getIteratorMethod$2 = function(it) {
  if (it != void 0)
    return getMethod$4(it, ITERATOR$4) || getMethod$4(it, "@@iterator") || Iterators$3[classof$6(it)];
};
...
var speciesConstructor$2 = function(O2, defaultConstructor) {
  var C = anObject$9(O2).constructor;
  var S;
  return C === void 0 || (S = anObject$9(C)[SPECIES$2]) == void 0 ? defaultConstructor : aConstructor(S);
};
...
if (!set || !clear) {
  ...
  } else if (global$e.addEventListener && isCallable$6(global$e.postMessage) && !global$e.importScripts && location && location.protocol !== "file:" && !fails$b(post)) {
    defer = post;
...
var global$d = global$I;
var engineIsIosPebble = /ipad|iphone|ipod/i.test(userAgent$1) && global$d.Pebble !== void 0;
...
var NATIVE_REJECTION_EVENT = isCallable$5(global$a.PromiseRejectionEvent);
...
var isThenable = function(it) {
  var then2;
  return isObject$1(it) && isCallable$5(then2 = it.then) ? then2 : false;
};
...
var dispatchEvent = function(name, promise2, reason) {
  ...
  if (!NATIVE_REJECTION_EVENT && (handler = global$a["on" + name]))
    handler(event);
  else if (name === UNHANDLED_REJECTION)
    hostReportErrors("Unhandled promise rejection", reason);
};
var onUnhandled = function(state) {
  call$6(task, global$a, function() {
...
$$9({ target: PROMISE, stat: true, forced: INCORRECT_ITERATION }, {
  ...
  race: function race(iterable) {
    ...
    var result = perform(function() {
      var $promiseResolve = aCallable$1(C.resolve);
      iterate(iterable, function(promise2) {
        call$6($promiseResolve, C, promise2).then(capability.resolve, reject2);
      });
    });
    if (result.error)
      reject2(result.value);
...
var defineIterator$1 = function(Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED2) {
...
function o(t2, r2, e2) {
  ...
  t2.cX = v2[0] + (r2 + s2) / 2, t2.cY = v2[1] + (e2 + u2) / 2, t2.phi1 = Math.atan2((y2 - T2) / o2, (c2 - l2) / a2), t2.phi2 = Math.atan2((-y2 - T2) / o2, (-c2 - l2) / a2), t2.sweepFlag === 0 && t2.phi2 > t2.phi1 && (t2.phi2 -= 2 * n), t2.sweepFlag === 1 && t2.phi2 < t2.phi1 && (t2.phi2 += 2 * n), t2.phi1 *= 180 / n, t2.phi2 *= 180 / n;
}
function s(t2, r2, e2) {
  a(t2, r2, e2);
...
!function(t2) {
  ...
  function O2(t3, r3, e3, i2, n3, o2) {
    return a(t3, r3, e3, i2, n3, o2), u2(function(a2, s2, u3, h2) {
      var c2 = a2.x1, y2 = a2.x2, p2 = a2.relative && !isNaN(h2), m2 = a2.x !== void 0 ? a2.x : p2 ? 0 : s2, O3 = a2.y !== void 0 ? a2.y : p2 ? 0 : u3;
      function l3(t4) {
        return t4 * t4;
      }
      a2.type & _.HORIZ_LINE_TO && r3 !== 0 && (a2.type = _.LINE_TO, a2.y = a2.relative ? 0 : u3), a2.type & _.VERT_LINE_TO && e3 !== 0 && (a2.type = _.LINE_TO, a2.x = a2.relative ? 0 : s2), a2.x !== void 0 && (a2.x = a2.x * t3 + O3 * e3 + (p2 ? 0 : n3)), a2.y !== void 0 && (a2.y = m2 * r3 + a2.y * i2 + (p2 ? 0 : o2)), a2.x1 !== void 0 && (a2.x1 = a2.x1 * t3 + a2.y1 * e3 + (p2 ? 0 : n3)), a2.y1 !== void 0 && (a2.y1 = c2 * r3 + a2.y1 * i2 + (p2 ? 0 : o2)), a2.x2 !== void 0 && (a2.x2 = a2.x2 * t3 + a2.y2 * e3 + (p2 ? 0 : n3)), a2.y2 !== void 0 && (a2.y2 = y2 * r3 + a2.y2 * i2 + (p2 ? 0 : o2));
      var T2 = t3 * i2 - r3 * e3;
  ...
  t2.ROUND = function(t3) {
    ...
    return u2(function(a2, o2, s2, u3, h2) {
      ...
      if (a2.type & _.SMOOTH_CURVE_TO && (p2 = isNaN(r3) ? 0 : o2 - r3, m2 = isNaN(e3) ? 0 : s2 - e3), a2.type & (_.CURVE_TO | _.SMOOTH_CURVE_TO) ? (r3 = a2.relative ? o2 + a2.x2 : a2.x2, e3 = a2.relative ? s2 + a2.y2 : a2.y2) : (r3 = NaN, e3 = NaN), a2.type & _.SMOOTH_QUAD_TO ? (i2 = isNaN(i2) ? o2 : 2 * o2 - i2, n3 = isNaN(n3) ? s2 : 2 * s2 - n3) : a2.type & _.QUAD_TO ? (i2 = a2.relative ? o2 + a2.x1 : a2.x1, n3 = a2.relative ? s2 + a2.y1 : a2.y2) : (i2 = NaN, n3 = NaN), a2.type & _.LINE_COMMANDS || a2.type & _.ARC && (a2.rX === 0 || a2.rY === 0 || !a2.lArcFlag) || a2.type & _.CURVE_TO || a2.type & _.SMOOTH_CURVE_TO || a2.type & _.QUAD_TO || a2.type & _.SMOOTH_QUAD_TO) {
        ...
        p2 = isNaN(i2) ? a2.x1 === void 0 ? p2 : a2.relative ? a2.x : a2.x1 - o2 : i2 - o2, m2 = isNaN(n3) ? a2.y1 === void 0 ? m2 : a2.relative ? a2.y : a2.y1 - s2 : n3 - s2;
