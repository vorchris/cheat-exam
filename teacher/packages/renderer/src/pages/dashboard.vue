...
<div id="wrapper" class="w-100 h-100 d-flex" >
    ...
    <div :key="5" class="p-3 text-white bg-dark h-100 " style="width: 240px; min-width: 240px;">
        ...
        <div style="font-size:0.9em; width: 220px">
            ...
            <!-- microsoft365 -->
            <div class="form-check m-1 mb-3" :class="( (serverstatus.exammode && this.config.accessToken) || ( serverstatus.exammode && serverstatus.examtype !== 'microsoft365') ) ? 'disabledexam':''">
